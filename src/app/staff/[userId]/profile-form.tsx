...
import { updateStaffProfileAction, type ActionState } from "./actions";
...
export function ProfileForm({
  ...
  const [state, formAction, pending] = useActionState(updateStaffProfileAction, INITIAL);
  ...
  return (
    <form action={formAction} className="grid gap-3 sm:grid-cols-3">
      ...
      <label className="grid gap-1 text-sm">
        ...
        <input name="name" defaultValue={name ?? ""} className="rounded border px-3 py-2 text-sm outline-none focus:border-[var(--bt-primary)]" style={{ borderColor: "var(--bt-border)" }} />
      </label>
      <label className="grid gap-1 text-sm">
      ...
      <label className="grid gap-1 text-sm">
        ...
        <input name="phone" defaultValue={phone ?? ""} className="rounded border px-3 py-2 text-sm outline-none focus:border-[var(--bt-primary)]" style={{ borderColor: "var(--bt-border)" }} />
      </label>
