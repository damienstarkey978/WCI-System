...
import { PROJECT_MANAGEMENT_NAV, REPORTS_HREF, TOP_LEVEL_NAV } from "@/lib/buildertrend-nav";
 ...
 * icon cluster on the right. Client component only for the dropdown's open state.
 */
